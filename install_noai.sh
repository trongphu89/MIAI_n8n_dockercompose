...
wget https://raw.githubusercontent.com/trongphu89/MIAI_n8n_dockercompose/refs/heads/main/compose_noai.yaml -O compose.yaml
export EXTERNAL_IP=https://n8n.trongphu.com
docker compose up -d
